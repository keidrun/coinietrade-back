...
exports.errors = {
  ...
  POLICY_READ_DATA_NOT_FOUND_BY_ID: { code: 7102, message: "Policy data with the provided 'id' NOT found" },
  POLICY_DELETE_DATA_NOT_FOUND_BY_USER_ID: {
    code: 7103,
    message: "Policy data with the provided 'userId' NOT found"
  },
  POLICY_UPDATE_DATA_NOT_FOUND_BY_ID: { code: 7104, message: "Policy data with the provided 'id' NOT found" },
  POLICY_INVALID_EXPIRED_AT: { code: 7105, message: "Required field Policy 'expiredAt' is invalid" },
  // Secret model errors
  SECRET_MISSING_USER_ID: { code: 7201, message: "Required field Secret 'userId' is missing" },
  SECRET_MISSING_API_PROVIDER: { code: 7202, message: "Required field Secret 'apiProvider' is missing" },
  SECRET_MISSING_API_KEY: { code: 7203, message: "Required field Secret 'apiKey' is missing" },
  SECRET_MISSING_API_SECRET: { code: 7204, message: "Required field Secret 'apiSecret' is missing" },
  SECRET_DELETE_DATA_NOT_FOUND_BY_IDS: {
    code: 7205,
    message: "Secret data with the provided 'userId' and 'secretId' NOT found"
  },
  // Rule model errors
  RULE_MISSING_USER_ID: { code: 7301, message: "Required field Rule 'userId' is missing" },
