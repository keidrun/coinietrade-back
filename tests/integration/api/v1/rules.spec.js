...
describe('rules endpoints', () => {
  ...
  describe('POST /v1/rules', () => {
    test('should return added data response wtesth all arguments', (done) => {
      axios
        .post(`/v1/rules`, {
          userId: groupUserId,
          priority: 1,
    ...
    test('should return added data response with all arguments', (done) => {
      axios
        .post(`/v1/rules`, {
          userId: groupUserId,
          priority: 2,
    ...
    test('should return added data response without option arguments', (done) => {
      axios
        .post(`/v1/rules`, {
          userId: uuid.v4(),
          strategy: 'simple_arbitrage',
  ...
  describe('GET /v1/rules/{userId}', () => {
    test('should return data with the same userId', (done) => {
      axios
